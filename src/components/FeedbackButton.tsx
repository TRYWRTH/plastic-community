  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-24 right-4 z-40 inline-flex items-center gap-2 rounded-full bg-primary px-3 py-2 font-mono text-xs uppercase tracking-widest text-primary-foreground"
      >
